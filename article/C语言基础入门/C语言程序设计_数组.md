...
- [字符数组与字符串](#字符数组与字符串)
  - [1、字符串](#1字符串)
  - [2、运算符：sizeof()](#2运算符sizeof)
    - [sizeof()的用法](#sizeof的用法)
      - [sizeof(数据类型名称)](#sizeof数据类型名称)
      - [sizeof(变量名称或数组名称)](#sizeof变量名称或数组名称)
      - [sizeof(字符串常量)](#sizeof字符串常量)
  - [3、strlen()函数](#3strlen函数)
  - [4、总结](#4总结)
- [说明](#说明)
...
![一维数组内存布局](https://mmbiz.qpic.cn/mmbiz_jpg/iaumSdLKJXtQ8QIPf25Hcygz3eCYWcjuyASEUSQh4JdDYZPKtm92AaxBQLQLNXrWZPWGcuxXLhut1dpPV2tG6qw/640?wx_fmt=jpeg&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
